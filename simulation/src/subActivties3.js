...
`;
	 ...
	 function shuffleArray(array) {
        ...
        // Shuffle statements
        let shuffledData = shuffleArray([...subJsonData2.statements]);
...
//	 +'</h5>'
	 ...
	 +'  What is the sequence of operation to be configured before starting the plant? (Manual Mode(From SCADA Screen))'
...
$(document).ready(function () {
    ...
    $('#verifyButton').click(function () {
        ...
        if (correctCount === subJsonData2.statements.length) {
		 ...
		 <table class="table table-striped">
			    ...
			    <tbody id="dataTable">
				    ...
				    $("#diagram").html(htm);	
					 ...
					 subJsonData2.statements.forEach(function (item) {
            var row = `<tr>
                <td>${item.step_no}</td>
                <td>${item.statement}</td>
            </tr>`;
