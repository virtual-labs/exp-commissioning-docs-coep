...
function subActivties2()
{
    ...
    $("#counter").prop("hidden",false);
	 ...
	 function shuffleArray(array) {
        ...
        // Shuffle statements
        let shuffledData = shuffleArray([...subJsonData1.statements]);
...
<!-- 			  End Modal ProStr -->`;
		...
		$("#NextLevel").click(function () {
			 resultJson.subActivtiesCount2=subActivtiesCount2;
			subActivties3();
		});
// Shuffle function
...
//		resultJson.alamCount=alamCount;
...
$(document).ready(function () {
    ...
    $('#verifyButton').click(function () {
        ...
        if (correctCount === subJsonData1.statements.length) {
		 ...
		 <table class="table table-striped">
			    ...
			    <tbody id="dataTable">
				    ...
				    $("#diagram").html(htm);	
					 ...
					 subJsonData1.statements.forEach(function (item) {
            var row = `<tr>
                <td>${item.step_no}</td>
                <td>${item.statement}</td>
            </tr>`;
